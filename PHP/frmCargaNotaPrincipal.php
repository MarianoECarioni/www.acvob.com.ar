...
<form id="form1" name="form1" method="GET" action="frmCargaNotaPrincipal.php" >
        <table  id="nota_principal" background=<?php echo $IMAGEN; ?>  border="1">
          <tr  class="foto" <a href="#" onclick="afoto('<?php echo $IMAGEN; ?>','Nota Principal');return false" >  
            <td></td>
          </tr>
          <tr class="piefoto">
            <td><p><input id="texPie" name='ipie' type='text' maxlength='30' value=<?php echo $PIE; ?> /></p></td>                            
          </tr>
          <tr  class='pie'>
            <td>
              <h1><input class="Fields" id="titulo" name='ititulo' type='text' maxlength='30' value="<?php echo $TITULO; ?>" /></h1>
